...
//        mainThreadAndAsyncThread();
        ...
        Long start = System.currentTimeMillis();
            ...
            new Thread(() -> {
                for (int i = 0; i < 10; i++) {
                    ...
                    countDownAndPrint(countDownLatch, 1);//递减
                }
            }).start();
    ...
    /**
     * countDown() 并且打印，其实是不需要synchronized的，这里只是为了多线程环境下正确打印
     **/
    private static void countDownAndPrint(CountDownLatch countDownLatch, int seconds) {
